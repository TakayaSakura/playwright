...
(async () => {
    ...
    for (let i = 1; i <= 7; i++) {
        const inputformpass = `body > table:nth-child(4) > tbody > tr:nth-child(${1}) > td > input[type=textbox]`
        const inputform = `sample${i}`
...
const sample2 = `あ`//〇〇課
const sample3 = `あ`//システム管理者名
const sample4 = `あ`//システム名
const sample5 = `あ`//文書番号
const sample6 = `あ`//記入日
const sample7 = `あ`//記入担当者